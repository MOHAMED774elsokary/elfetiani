...
export default function Testimonials({ lang }: TestimonialsProps) {
  ...
  return (
    <section id="testimonials" className="py-24 relative bg-[#080706] overflow-hidden" ref={ref}>
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse 70% 40% at 50% 80%, rgba(232, 82, 13, 0.04) 0%, transparent 70%)' }} />
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-1 mt-3">
            {[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 text-[#E8520D] fill-[#E8520D]" />)}
            <span className="text-white/40 text-sm ml-2 font-bold">4.9 / 5</span>
          </div>
          <div className="w-16 h-1 bg-[#E8520D] mx-auto rounded-full mt-6 shadow-[0_0_10px_rgba(232, 82, 13, 0.6)]" />
        </motion.div>
        ...
        <div className="relative group/carousel">
          ...
          >
            {list.map((r, i) => (
              <motion.div
                ...
                className="w-[85vw] shrink-0 snap-center md:w-[45vw] lg:w-auto bg-transparent border border-white/5 hover:border-[#E8520D]/25 rounded-2xl overflow-hidden flex flex-col gap-0 transition-colors duration-500 group"
                dir={lang === 'ar' ? 'rtl' : 'ltr'}
              >
                {/* Image Container */}
          ...
          <button 
            ...
            className="absolute left-1 top-[40%] -translate-y-1/2 p-2.5 bg-black/60 backdrop-blur-md rounded-full text-white border border-white/10 hover:bg-[#E8520D] hover:border-[#E8520D] transition-all lg:hidden z-20 shadow-lg pointer-events-auto active:scale-95"
            aria-label="Previous"
          >
          ...
          <button 
            ...
            className="absolute right-1 top-[40%] -translate-y-1/2 p-2.5 bg-black/60 backdrop-blur-md rounded-full text-white border border-white/10 hover:bg-[#E8520D] hover:border-[#E8520D] transition-all lg:hidden z-20 shadow-lg pointer-events-auto active:scale-95"
            aria-label="Next"
          >
