    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-[#FF5500] font-bold text-xl drop-shadow-md">
            {t.subtitle}
          </p>
          ...
          <div className="flex items-center justify-center gap-2 mt-8 lg:hidden text-white/60 bg-white/5 w-max mx-auto px-4 py-2 rounded-full border border-white/10">
            <MoveHorizontal className="w-5 h-5 animate-pulse text-[#FF5500]" />
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <button 
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 z-50 p-4 rounded-full bg-black/50 hover:bg-[#FF5500] border border-white/10 hover:border-[#FF5500] text-white transition-all shadow-xl backdrop-blur-md hidden lg:block"
          >
            <ChevronLeft className="w-8 h-8" />
          </button>
          <button 
            onClick={() => scroll(lang === 'ar' ? 'left' : 'right')} 
            className="absolute right-4 top-1/2 -translate-y-1/2 z-50 p-4 rounded-full bg-black/50 hover:bg-[#FF5500] border border-white/10 hover:border-[#FF5500] text-white transition-all shadow-xl backdrop-blur-md hidden lg:block"
          >
                ...
                >
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-end text-end">
                    ...
                    >
                      ...
                      <div className="h-[2px] w-0 bg-[#FF5500] mb-3 group-hover:w-full transition-all duration-700 ease-in-out" />
                      
                      <p className="text-[#FF5500] font-bold text-lg opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-100">
                        {item.result}
                      </p>
